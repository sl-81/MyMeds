...
// Represents a new user generated by the launching of the app, initiates all fields required for app to run
...
public class MyMedsUser {
    ...
    private void printInstructions() {
        ...
        System.out.println("type 'save' to save the current list");
        System.out.println("type 'load' to load the previously saved list");
    ...
    private void addPatient() throws DateTimeException {
